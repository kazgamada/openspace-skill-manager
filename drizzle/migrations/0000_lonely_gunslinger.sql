CREATE TYPE "public"."asset_type" AS ENUM('skill', 'hook', 'command', 'agent', 'mcp', 'claude_md', 'other');--> statement-breakpoint
...
CREATE TABLE "community_assets" (
	"id" varchar(64) PRIMARY KEY NOT NULL,
	"assetType" "asset_type" DEFAULT 'other' NOT NULL,
	"name" varchar(255) NOT NULL,
	"description" text,
	"benefitHeadline" text,
	"author" varchar(128),
...
--> statement-breakpoint
CREATE TABLE "daily_hero_picks" (
	"id" serial PRIMARY KEY NOT NULL,
	"assetId" varchar(64) NOT NULL,
	"heroDate" varchar(10) NOT NULL,
	"position" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "plans" (
	...
	"priceYearlyUsd" integer DEFAULT 0 NOT NULL,
	"stripePriceIdMonthly" varchar(64),
	"stripePriceIdYearly" varchar(64),
	"features" text,
...
--> statement-breakpoint
ALTER TABLE "asset_favorites" ADD CONSTRAINT "asset_favorites_assetId_community_assets_id_fk" FOREIGN KEY ("assetId") REFERENCES "public"."community_assets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_favorites" ADD CONSTRAINT "asset_favorites_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_ratings" ADD CONSTRAINT "asset_ratings_assetId_community_assets_id_fk" FOREIGN KEY ("assetId") REFERENCES "public"."community_assets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_ratings" ADD CONSTRAINT "asset_ratings_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_set_items" ADD CONSTRAINT "asset_set_items_setId_asset_sets_id_fk" FOREIGN KEY ("setId") REFERENCES "public"."asset_sets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_set_items" ADD CONSTRAINT "asset_set_items_assetId_community_assets_id_fk" FOREIGN KEY ("assetId") REFERENCES "public"."community_assets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_sets" ADD CONSTRAINT "asset_sets_createdBy_users_id_fk" FOREIGN KEY ("createdBy") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "daily_hero_picks" ADD CONSTRAINT "daily_hero_picks_assetId_community_assets_id_fk" FOREIGN KEY ("assetId") REFERENCES "public"."community_assets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_subscriptions" ADD CONSTRAINT "user_subscriptions_planId_plans_id_fk" FOREIGN KEY ("planId") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "webhook_subscriptions" ADD CONSTRAINT "webhook_subscriptions_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;